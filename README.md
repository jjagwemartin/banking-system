#NB there are two program codes below,bank sys.py and filestore.py that must be saved independently to run bank sys.py program
...
#create a new folder
#within this new folder, use notepad software and create 4 text files namely:
#acc_name.txt, cusbalfile.txt, cusnamefile.txt and cuspassfile.txt
#from the codes below, get the bank sys.py code and also save it in the created folder
#still in the code below jst afta bank sys code,their is another code filestore.py also get it and save it in the created folder
#then you can now open the bank sys.py code and run it to do the banking system services as required
############################################################################################################
############################################################################################################
...
#below is the filestore.py code that also has to be stored in the same folder as the above code of bank sys.py
###############################################################################################################
####################################################################################################################
#######################      filestore.py code            #####################################################
